...
Note: Requires Node 18+. Desktop only. 

## What is included
2D to 3D camera transition, view toggles (headshots, titles, locations, agents), zoom levels, click-to-detail on each card, and an in-app JSON editor for customizing the org data.
